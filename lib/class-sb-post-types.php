...
if ( ! class_exists( 'SB_Post_Types' ) ) {
	...
	/**
	 * Class creates two custom post types for the theme: Art and Employment
	 */
	class SB_Post_Types
	{
		/**
		...
		/**
		 * registers two custom post types for art and employment
		 */
		public static function register_post_types()
		{
			...
			/* Employment post type and taxonomy */
			register_post_type( 'employment', array(
				'labels'          => array_merge( $default_labels, $employment_labels ),
				'public'          => true,
				'query_var'       => true,
				'capability_type' => 'page',
				'has_archive'     => true, 
			...
			$cat_labels = array(
				...
				'singular_name'     => 'Employment Categories',
				'search_items'      => 'Search Employment Categories',
				'all_items'         => 'All Employment Categories',
				'parent_item'       => 'Parent Category',
				'parent_item_colon' => 'Parent Category:',
				'edit_item'         => 'Edit Category', 
				'update_item'       => 'Update Category',
				'add_new_item'      => 'Add New Category',
				'new_item_name'     => 'New Employment Category Name',
			); 	
			register_taxonomy( 'employment_category', array('employment'), array(
				'hierarchical'      => true,
				'labels'            => $cat_labels,
				'show_ui'           => true,
				'query_var'         => true,
		...
		{
			if ( 0 && ! is_admin() && is_main_query() && ( is_tax('employment_category') || is_tax('art_category') ) ) {
